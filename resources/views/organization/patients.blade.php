                        ...
                        <div class="row">
                            ...
                            <div class="d-flex flex-column justify-content-between ms-0 ps-0">
                                <div class="nav flex-column nav-pills nav-pills-custom" id="v-pills-tab" role="tablist"
                                    ...
                                    <a href="{{route("organization.patients")}}" class="active nav-link text-left patient-directory-tab"
                                    ...
                                    <a href="{{route("organization.practitioners")}}" class="nav-link text-left practitioner-directory-tab"
