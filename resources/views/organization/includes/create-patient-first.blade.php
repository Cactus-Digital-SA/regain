...
<div class="modal-body" id="modal-container" data-page-id="1">
        ...
        <div class="row g-4">
            <div class="col-md-6">
                ...
                <input type="text" id="name" class="form-control new-patient-input required" placeholder="ex. Olha Maximova" required>
            </div>
            <div class="col-md-6">
                <label for="date-of-birthday" class="form-label">Date of Birth</label>
                <input type="text" id="date-of-birthday" class="form-control new-patient-input required" placeholder="DD/MM/YYYY" required>
            </div>
            <div class="col-md-6">
                <label for="region" class="form-label">Region</label>
                <select id="region" class="form-control new-patient-input required" placeholder="Select region" required>
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="post-code" class="form-control new-patient-input required" placeholder="ex. 54624" required>
            </div>
            <div class="col-md-6">
                <label for="primary-phone" class="form-label">Primary Phone Number</label>
                <input type="text" id="primary-phone" class="form-control new-patient-input required§" placeholder="ex. +123 456 789" required>
            </div>
            <div class="col-md-6">
                <label for="email" class="form-label">Email</label>
                <input type="text" id="email" class="form-control new-patient-input required" placeholder="ex. maximova@gmail.com" required>
            </div>
            <div class="col-md-6">
