            ...
            <li class="menu-item has-sub {{ activeClass(request()->is('admin/tests*'),'open') }}">
                ...
                <ul class="menu-sub">
                    <li class="menu-item {{ activeClass(request()->is('admin/tests/questions'),'active') }}">
                        <a class="menu-link" href="{{ route('admin.tests.questions.index') }}">
