...
@section('content-header-breadcrumbs')
    ...
    <li class="breadcrumb-item">
        <a href="{{route('admin.tests.instructions.index')}}">{{__('Instructions')}}</a>
    </li>
    <li class="breadcrumb-item active">
        <a href="{{route('admin.tests.instructions.create')}}">{{__('Create Instruction')}}</a>
    </li>
@endsection

@section('content')
    <form id="form" method="POST" action="{{ route('admin.tests.instructions.store') }}" class="form-horizontal">
        @csrf
        <div class="row">
            <div class="col-md-12">
