      ...
      <div class="row gx-0 gy-4 g-md-5">
        <div class="col-lg-5">
          <a href="{{url('front-pages/landing')}}" class="app-brand-link mb-4">
            ...
            <span class="app-brand-text demo footer-link fw-bold ms-2 ps-1">{{ config('appVariables.templateName') }}</span>
          </a>
  ...
  <div class="footer-bottom py-3">
    <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
      <div class="mb-2 mb-md-0">
        ...
        <a href="{{config('appVariables.creatorUrl')}}" target="_blank" class="fw-medium text-white footer-link">{{config('appVariables.creatorName')}},</a>
        <span class="footer-text"> Made with ❤️ for a better web.</span>
      </div>
      <div>
        <a href="{{config('appVariables.githubFreeUrl')}}" class="footer-link me-3" target="_blank">
        ...
        <a href="{{config('appVariables.facebookUrl')}}" class="footer-link me-3" target="_blank">
        ...
        <a href="{{config('appVariables.twitterUrl')}}" class="footer-link me-3" target="_blank">
        ...
        <a href="{{config('appVariables.instagramUrl')}}" class="footer-link" target="_blank">
