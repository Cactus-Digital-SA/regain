    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 60%; max-height: 100%">
        <div class="modal-content p-3 p-md-5" style="background-color: rgba(255, 255, 255, 1);">
            <div class="modal-body" id="modal-container">
                ...
                <h3 class="text-center mb-4" style="rgba(10, 19, 58, 1); font-weight: 700; font-size: 24px;">New Patient
                    Registration</h3>
                <form>
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="input1" class="form-control"
                                   style="background-color: rgba(221, 222, 241, 1); min-width: 400px;">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6 mt-5">
                            <button type="button" class="btn btn-primary btn-next"
                                    style="background-color: rgba(10, 19, 58, 1); min-width: 250px;" id="btn-next">Next
                            </button>
                        </div>
                    </div>
                </form>
