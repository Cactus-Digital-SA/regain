                        ...
                        <div class="row">
                            ...
                            <div class="d-flex flex-column justify-content-between ms-0 ps-0">
                                <div class="nav flex-column nav-pills nav-pills-custom" id="v-pills-tab" role="tablist"
                                    ...
                                    <a class="nav-link active text-left" id="v-pills-calendar-tab" data-bs-toggle="pill"
                    ...
                    <div class="col-xxl-4 col-5">
                        <div class="card overflow-hidden mb-0 mt-4 d-flex justify-content-center align-items-center" style="background-color: #dddef1; border-radius: 20px">
                            <div class="card-body p-0 m-0">
                                ...
                                <div class="calendar-footer d-flex justify-content-center align-items-center px-2 py-3" style="background-color: #dddef1">
                                    <button class="appointment-overview position-relative w-100" style="border-radius: 20px; border: 2px solid; font-weight: 700; font-size: 15px; background-color: transparent">Appointment Overview</button>
                                </div>
                            </div>
                        </div>
                    </div>
